...
package io.github.lxgaming.northerncompass.neoforge.executor;

import io.github.lxgaming.northerncompass.common.client.renderer.item.AngleCompassProperty;
import io.github.lxgaming.northerncompass.neoforge.NeoForgeMod;
...
public class ClientExecutor {
    ...
    public static void onRegisterItem() {
        ...
        if (angleCompassProperty == null) {
            NeoForgeMod.getInstance().getLogger().warn("Compass Angle Property is unavailable");
        }
