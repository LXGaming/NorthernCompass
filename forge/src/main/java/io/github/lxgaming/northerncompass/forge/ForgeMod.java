...
public class ForgeMod extends NorthernCompass {
    ...
    public ForgeMod() {
        ...
        MinecraftForge.EVENT_BUS.addListener((WorldEvent.Load event) -> LevelListener.onLoadLevel(event.getWorld()));
    ...
    public void onClientSetup(FMLClientSetupEvent event) {
        ...
        DistExecutor.safeRunWhenOn(Dist.CLIENT, () -> ClientExecutor::onRegisterItem);
    }
}